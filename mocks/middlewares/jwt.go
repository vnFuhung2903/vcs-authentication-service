...
// Source: vcs-authentication-service/pkg/middlewares/jwt.go
...
// CheckBearerAuth mocks base method.
func (m *MockIJWTMiddleware) CheckBearerAuth() gin.HandlerFunc {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckBearerAuth")
	ret0, _ := ret[0].(gin.HandlerFunc)
	return ret0
}

// CheckBearerAuth indicates an expected call of CheckBearerAuth.
func (mr *MockIJWTMiddlewareMockRecorder) CheckBearerAuth() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckBearerAuth", reflect.TypeOf((*MockIJWTMiddleware)(nil).CheckBearerAuth))
}
